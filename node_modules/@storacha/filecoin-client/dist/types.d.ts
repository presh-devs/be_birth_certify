import { ConnectionView, ServiceMethod, Signer, Proof, DID, Principal } from '@ucanto/interface';
import { FilecoinOffer, FilecoinOfferSuccess, FilecoinOfferFailure, FilecoinSubmit, FilecoinSubmitSuccess, FilecoinSubmitFailure, FilecoinAccept, FilecoinAcceptSuccess, FilecoinAcceptFailure, FilecoinInfo, FilecoinInfoSuccess, FilecoinInfoFailure, PieceOffer, PieceOfferSuccess, PieceOfferFailure, PieceAccept, PieceAcceptSuccess, PieceAcceptFailure, AggregateOffer, AggregateOfferSuccess, AggregateOfferFailure, AggregateAccept, AggregateAcceptSuccess, AggregateAcceptFailure, DealInfo, DealInfoSuccess, DealInfoFailure } from '@storacha/capabilities/types';
