 ...
 */
export function dealInfo({ issuer, with: resource, proofs, audience }: import("./types.js").InvocationConfig, piece: import("@web3-storage/data-segment").PieceLink, options?: import("./types.js").RequestOptions<DealTrackerService>): Promise<import("@ucanto/interface").Receipt<import("@storacha/capabilities/types").DealInfoSuccess, import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@ucanto/client").InvalidAudience | import("@ucanto/client").Unauthorized | import("@storacha/capabilities/types").DealInfoFailure, import("@ucanto/interface").Invocation<import("@ucanto/client").Capability<import("@ucanto/client").Ability, `${string}:${string}`, unknown>>, import("@ucanto/client").SigAlg>>;
/**
