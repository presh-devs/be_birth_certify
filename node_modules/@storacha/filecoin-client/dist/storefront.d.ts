 ...
 */
export function filecoinOffer({ issuer, with: resource, proofs, audience }: import("./types.js").InvocationConfig, content: import("multiformats").UnknownLink, piece: import("@web3-storage/data-segment").PieceLink, options?: import("./types.js").RequestOptions<StorefrontService>): Promise<import("@ucanto/interface").Receipt<import("@storacha/capabilities/types").FilecoinOfferSuccess, import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@ucanto/client").InvalidAudience | import("@ucanto/client").Unauthorized | import("@storacha/capabilities/types").FilecoinOfferFailure, import("@ucanto/interface").Invocation<import("@ucanto/client").Capability<import("@ucanto/client").Ability, `${string}:${string}`, unknown>>, import("@ucanto/client").SigAlg>>;
/**
 ...
 * @param {import('./types.js').RequestOptions<StorefrontService>} [options]
 */
export function filecoinSubmit({ issuer, with: resource, proofs, audience }: import("./types.js").InvocationConfig, content: import("multiformats").UnknownLink, piece: import("@web3-storage/data-segment").PieceLink, options?: import("./types.js").RequestOptions<StorefrontService>): Promise<import("@ucanto/interface").Receipt<import("@storacha/capabilities/types").FilecoinSubmitSuccess, import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@ucanto/client").InvalidAudience | import("@ucanto/client").Unauthorized | import("@storacha/capabilities/types").FilecoinSubmitFailure, import("@ucanto/interface").Invocation<import("@ucanto/client").Capability<import("@ucanto/client").Ability, `${string}:${string}`, unknown>>, import("@ucanto/client").SigAlg>>;
/**
 ...
 * @param {import('./types.js').RequestOptions<StorefrontService>} [options]
 */
export function filecoinAccept({ issuer, with: resource, proofs, audience }: import("./types.js").InvocationConfig, content: import("multiformats").UnknownLink, piece: import("@web3-storage/data-segment").PieceLink, options?: import("./types.js").RequestOptions<StorefrontService>): Promise<import("@ucanto/interface").Receipt<import("@storacha/capabilities/types").FilecoinAcceptSuccess, import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@ucanto/client").InvalidAudience | import("@ucanto/client").Unauthorized | import("@storacha/capabilities/types").FilecoinAcceptFailure, import("@ucanto/interface").Invocation<import("@ucanto/client").Capability<import("@ucanto/client").Ability, `${string}:${string}`, unknown>>, import("@ucanto/client").SigAlg>>;
/**
 ...
 * @param {import('./types.js').RequestOptions<StorefrontService>} [options]
 */
export function filecoinInfo({ issuer, with: resource, proofs, audience }: import("./types.js").InvocationConfig, piece: import("@web3-storage/data-segment").PieceLink, options?: import("./types.js").RequestOptions<StorefrontService>): Promise<import("@ucanto/interface").Receipt<import("@storacha/capabilities/types").FilecoinInfoSuccess, import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@ucanto/client").InvalidAudience | import("@ucanto/client").Unauthorized | import("@storacha/capabilities/types").FilecoinInfoFailure, import("@ucanto/interface").Invocation<import("@ucanto/client").Capability<import("@ucanto/client").Ability, `${string}:${string}`, unknown>>, import("@ucanto/client").SigAlg>>;
/**
