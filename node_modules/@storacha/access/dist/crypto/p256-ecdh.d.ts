 ...
 */
export function pubkeyBytesFromDID(did: import("@ipld/dag-ucan").DID): Promise<Uint8Array<ArrayBuffer>>;
/**
...
export class EcdhKeypair implements SharedKey {
    ...
    did: `did:${string}:${string}`;
    pubkey(): Promise<Uint8Array<ArrayBuffer>>;
    /**
    ...
    decryptFromDid(data: string, otherDID: import("@ipld/dag-ucan").DID): Promise<string>;
    #private;
}
