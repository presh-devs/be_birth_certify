...
export class AgentData implements AgentDataModel {
     ...
     */
    static create(init?: Partial<import("./types.js").AgentDataModel>, options?: import("./types.js").AgentDataOptions): Promise<AgentData>;
    /**
     ...
     * @param {import('./types.js').AgentDataOptions} [options]
     */
    static fromExport(raw: import("./types.js").AgentDataExport, options?: import("./types.js").AgentDataOptions): AgentData;
    /**
     * @param {import('./types.js').AgentDataModel} data
     * @param {import('./types.js').AgentDataOptions} [options]
     */
    constructor(data: import("./types.js").AgentDataModel, options?: import("./types.js").AgentDataOptions);
    ...
    delegations: Map<string, {
        ...
        delegation: EdSigner.Delegation;
    }>;
     ...
     */
    addSpace(did: import("@ucanto/interface").DID, meta: import("./types.js").SpaceMeta, proof?: import("@ucanto/interface").Delegation): Promise<void>;
    /**
     * @deprecated
     ...
     */
    addDelegation(delegation: import("@ucanto/interface").Delegation, meta?: import("./types.js").DelegationMeta): Promise<void>;
    /**
...
export function isSessionProof(delegation: Ucanto.Delegation): delegation is Ucanto.Delegation<[import("./types.js").UCANAttest]>;
/**
