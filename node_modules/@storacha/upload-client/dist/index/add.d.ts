 ...
 */
export function add({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, index: import("../types.js").CARLink, options?: import("../types.js").RequestOptions): Promise<import("../types.js").SpaceIndexAddSuccess>;
...
export function input(index: import("../types.js").CARLink): {
    index: import("@storacha/capabilities/types").CARLink;
};
