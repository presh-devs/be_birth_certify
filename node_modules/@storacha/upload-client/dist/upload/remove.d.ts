 ...
 */
export function remove({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, root: import("multiformats").UnknownLink, options?: import("../types.js").RequestOptions): Promise<import("@storacha/capabilities/types").UploadAddSuccess>;
