 ...
 */
export function add({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, root: import("multiformats/link").UnknownLink, shards: import("../types.js").CARLink[], options?: import("../types.js").RequestOptions): Promise<import("../types.js").UploadAddSuccess>;
...
export function input(root: import("multiformats/link").UnknownLink, shards: import("../types.js").CARLink[]): {
    ...
    shards: import("@storacha/capabilities/types").CARLink[];
};
