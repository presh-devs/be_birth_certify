 ...
 */
export function get({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, root: import("multiformats/link").UnknownLink, options?: import("../types.js").RequestOptions): Promise<import("../types.js").UploadGetSuccess>;
