 ...
 */
export function get({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, multihash: import("multiformats").MultihashDigest, options?: import("../types.js").RequestOptions): Promise<{
    error?: undefined;
} & {
    ok: import("@storacha/capabilities/types").SpaceBlobGetSuccess;
}>;
