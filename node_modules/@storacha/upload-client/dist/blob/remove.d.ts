 ...
 */
export function remove({ issuer, with: resource, proofs, audience }: import("../types.js").InvocationConfig, multihash: import("multiformats").MultihashDigest, options?: import("../types.js").RequestOptions): Promise<{
    error?: undefined;
} & {
    ok: import("@storacha/capabilities/types").SpaceBlobRemoveSuccess;
}>;
/** Returns the ability used by an invocation. */
export const ability: "space/blob/remove";
