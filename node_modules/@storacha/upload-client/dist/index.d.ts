 ...
 * @returns {Promise<import('./types.js').AnyLink>}
 */
export function uploadBlocks(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, blocks: Iterable<import("@ipld/unixfs").Block>, { pieceHasher, ...options }?: import("./types.js").UploadOptions): Promise<import("./types.js").AnyLink>;
