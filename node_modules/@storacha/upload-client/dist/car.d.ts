...
export function headerEncodingLength(root?: import("./types.js").AnyLink): number;
/** @param {Block} block */
 ...
 */
export function encode(blocks: Iterable<Block> | AsyncIterable<Block>, root?: import("./types.js").AnyLink): Promise<import("./types.js").CARFile>;
/** @param {import('./types.js').BlobLike} car */
export function decode(car: import("./types.js").BlobLike): Promise<{
    blocks: import("@ipld/unixfs").Block<any, number, number, import("multiformats").Version>[];
    roots: import("./types.js").AnyLink[];
}>;
/**
